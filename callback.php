...
// アカウント情報設定
$channel_id = "1465980084";
$channel_secret = "5e3ca055dc029b3b25d05b0368beaab2";
$mid = "uf7809ff6923d968dfcc82c207c52bdd1";
...
function api_post_request($path, $post) {
    ...
    curl_setopt($ch, CURLOPT_PROXY, getenv("http://fixie:RI6IOrzzcysgZDI@velodrome.usefixie.com:80"));
